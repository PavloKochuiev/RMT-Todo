  ...
  render() {
    return (
      <Box>
        ...
        <Typography
          sx={{ fontSize: "20px", marginBottom: "24px", textAlign: "center" }}
        >
          Become focused, organized, and calm with RMT! <br /> One more task
        ...
        <Box
          sx={{ position: "absolute", top: "150px", right: "0px", zIndex: -1 }}
        >
          <img
            width={600}
            height={600}
